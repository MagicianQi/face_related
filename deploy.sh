...
--name face_detection \
-d -v /home/qishuo/PycharmProjects/sensitive_rec/models/face_detection:/models/face_detection \
--restart always \
-p 6902:6902 \
...
--mount type=bind,source=/home/qishuo/PycharmProjects/sensitive_rec/models/face_verification,target=/models/face_verification \
-t --entrypoint=tensorflow_model_server tensorflow/serving:1.13.0-gpu \
